# 1 "c:\\users\\admin\\desktop\\loadrunner (\355\362 \361\362\340\346\350\360\356\342\352\340)\\webtour_part2_(abgar)_task3_26.04_(kovalenko v)\\\\combined_WebTour_part2_Task3_26.04_(Kovalenko V).c"
...
# 1 "c:\\users\\admin\\desktop\\loadrunner (\355\362 \361\362\340\346\350\360\356\342\352\340)\\webtour_part2_(abgar)_task3_26.04_(kovalenko v)\\\\combined_WebTour_part2_Task3_26.04_(Kovalenko V).c" 2
...
# 2 "c:\\users\\admin\\desktop\\loadrunner (\355\362 \361\362\340\346\350\360\356\342\352\340)\\webtour_part2_(abgar)_task3_26.04_(kovalenko v)\\\\combined_WebTour_part2_Task3_26.04_(Kovalenko V).c" 2
...
"LAST"); }
# 3 "c:\\users\\admin\\desktop\\loadrunner (\355\362 \361\362\340\346\350\360\356\342\352\340)\\webtour_part2_(abgar)_task3_26.04_(kovalenko v)\\\\combined_WebTour_part2_Task3_26.04_(Kovalenko V).c" 2
...
# 4 "c:\\users\\admin\\desktop\\loadrunner (\355\362 \361\362\340\346\350\360\356\342\352\340)\\webtour_part2_(abgar)_task3_26.04_(kovalenko v)\\\\combined_WebTour_part2_Task3_26.04_(Kovalenko V).c" 2
...
# 5 "c:\\users\\admin\\desktop\\loadrunner (\355\362 \361\362\340\346\350\360\356\342\352\340)\\webtour_part2_(abgar)_task3_26.04_(kovalenko v)\\\\combined_WebTour_part2_Task3_26.04_(Kovalenko V).c" 2

# 1 "Delete_1_ticket.c" 1
Delete_1_ticket()
{
	tName = "07.GoTo_page_Itinerary";
	lr_start_transaction(tName);
	
	lr_output_message("¬ теле action1 - удаление последне созданного билета");
	...
	tName = "08.Delete_created_ticket";
	lr_start_transaction(tName);

		lr_output_message("Number of Tickets for DELETE is: %s",lr_eval_string("{Count}"));
		lr_output_message("");
		...
		"Name={Count}", "Value=on", "ENDITEM", 
		"Name=flightID", "Value={flightDELETE}", "ENDITEM",  
...
# 6 "c:\\users\\admin\\desktop\\loadrunner (\355\362 \361\362\340\346\350\360\356\342\352\340)\\webtour_part2_(abgar)_task3_26.04_(kovalenko v)\\\\combined_WebTour_part2_Task3_26.04_(Kovalenko V).c" 2

# 1 "Delete_ALL_ticket.c" 1
Delete_ALL_ticket()
{
	tName = "09.GoTo_page_Itinerary";
	lr_start_transaction(tName);
	
	lr_output_message("¬ теле action2 - удаление всех билетов");
...
# 7 "c:\\users\\admin\\desktop\\loadrunner (\355\362 \361\362\340\346\350\360\356\342\352\340)\\webtour_part2_(abgar)_task3_26.04_(kovalenko v)\\\\combined_WebTour_part2_Task3_26.04_(Kovalenko V).c" 2

# 1 "Action3.c" 1
Action3()
{
	lr_output_message("холостой ход");
	lr_output_message("");
	
	return 0;
}
# 8 "c:\\users\\admin\\desktop\\loadrunner (\355\362 \361\362\340\346\350\360\356\342\352\340)\\webtour_part2_(abgar)_task3_26.04_(kovalenko v)\\\\combined_WebTour_part2_Task3_26.04_(Kovalenko V).c" 2
...
# 9 "c:\\users\\admin\\desktop\\loadrunner (\355\362 \361\362\340\346\350\360\356\342\352\340)\\webtour_part2_(abgar)_task3_26.04_(kovalenko v)\\\\combined_WebTour_part2_Task3_26.04_(Kovalenko V).c" 2
